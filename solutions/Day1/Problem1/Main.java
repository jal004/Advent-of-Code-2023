package solutions.Day1.Problem1;
...
public class Main {
    public static void main(String[] args) throws IOException, URISyntaxException {
        URI inputUri = Objects.requireNonNull(solutions.Day1.Problem2.Main.class.getResource("input.txt")).toURI();
        String content = new String(Files.readAllBytes(Paths.get(inputUri)));

        int result = new solutions.Day1.Problem1.Solution().calibrationSum(content);
